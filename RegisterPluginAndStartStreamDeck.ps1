...
# The action UUID is typically the plugin UUID with a trailing segment (e.g. "net.oksala.sahkonhinta.price").
# Strip the last dot-separated segment to get the plugin UUID used for the Plugins folder name.
